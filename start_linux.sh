...
# Run the Docker Installation (assuming this is a Python script command)
python webui.py --linux-setup-elasticsearch

# Run the Docker Installation for Ollama (assuming this is a Python script command)
python webui.py --run-ollama
