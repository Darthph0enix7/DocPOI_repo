...
def install_tesseract():
    ...
    if not os.path.exists(tessdata_path):
        ...
        run_cmd(f"git -c http.postBuffer=524288000 clone --depth 1 {tessdata_repo_url} {tessdata_path}")
...
def initial_setup():
    ...
    if gpuchoice == "a":
        ...
        run_cmd("conda install -y pytorch==2.4.0 torchvision==0.19.0 torchaudio==2.4.0 pytorch-cuda=12.1 -c pytorch -c nvidia")
